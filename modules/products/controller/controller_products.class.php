...
include ($_SERVER['DOCUMENT_ROOT'] . "/products_ORM_2/modules/products/utils/functions_products.inc.php");
include ($_SERVER['DOCUMENT_ROOT'] . "/products_ORM_2/utils/upload.php");
include ($_SERVER['DOCUMENT_ROOT'] . "/products_ORM_2/utils/common.inc.php");
           ...
           'origin' => $result['datos']['origin'],
            ...
            'departure_date' => $result['datos']['departure_date'],
        	  ...
        	  'avatar' => $result_avatar['datos']
				...
				/////////////////insert into BD////////////////////////
        $arrValue = false;
        $path_model = $_SERVER['DOCUMENT_ROOT'] . '/products_ORM_2/modules/products/model/model/';
